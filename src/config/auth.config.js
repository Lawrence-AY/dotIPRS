...
module.exports = {
  ...
  sessionSecret: process.env.AUTH_SESSION_SECRET || process.env.IPRS_IDENTIFIER_HASH_SECRET || process.env.IPRS_PASSWORD || 'development-session-secret',
  sessionTtlSeconds: Number(process.env.AUTH_SESSION_TTL_SECONDS || 3600),
  defaultClientId: process.env.GATEWAY_BOOTSTRAP_CLIENT_ID || process.env.AUTH_SESSION_USERNAME || process.env.IPRS_USERNAME || 'gateway_dev_client',
