...
const schemas = {
  verifyId: Joi.object({ idNumber, serialNumber, fingerprint }),
  verifyPassport: Joi.object({ passportNumber, fingerprint }),
  verifyAlienCard: Joi.object({ alienCardNumber, fingerprint }),
